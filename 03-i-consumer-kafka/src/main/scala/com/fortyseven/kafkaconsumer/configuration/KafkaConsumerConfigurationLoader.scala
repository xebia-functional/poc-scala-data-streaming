...
class KafkaConsumerConfigurationLoader[F[_]: Async] extends ConfigurationHeader[F, KafkaConsumerConfiguration]:
  /**
   * @return
   ...
   */
  override def loadConfiguration(): F[KafkaConsumerConfiguration] =
