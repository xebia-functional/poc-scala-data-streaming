...
final class FlinkProcessorConfigurationLoader[F[_]: Async] extends ConfigurationHeader[F, FlinkProcessorConfiguration]:
   ...
   */
  override def loadConfiguration(): F[FlinkProcessorConfiguration] =
