...
final class ProcessorConfigurationLoader[F[_]: Async] extends ConfigurationAPI[F, ProcessorConfiguration]:
   ...
   */
  override def load(): F[ProcessorConfiguration] =
    ConfigSource.default.at("processor-flink").loadF[F, ProcessorConfiguration]()
